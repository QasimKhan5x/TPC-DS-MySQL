WITH STORE_SALES_YEAR_TOTAL AS (
    ...
    WHERE
        ...
        AND (D_YEAR = 1999 OR D_YEAR = 2000)
    GROUP BY
        C_CUSTOMER_ID,
        C_FIRST_NAME,
        C_LAST_NAME,
...
JOIN
    STORE_SALES_YEAR_TOTAL S2 ON S1.CUSTOMER_ID = S2.CUSTOMER_ID AND S1.DYEAR = 1999 AND S2.DYEAR = 2000
JOIN
    WEB_SALES_YEAR_TOTAL W1 ON S1.CUSTOMER_ID = W1.CUSTOMER_ID AND W1.DYEAR = 1999
JOIN
    WEB_SALES_YEAR_TOTAL W2 ON S1.CUSTOMER_ID = W2.CUSTOMER_ID AND W2.DYEAR = 2000
WHERE
    S1.YEAR_TOTAL > 0
    AND W1.YEAR_TOTAL > 0
