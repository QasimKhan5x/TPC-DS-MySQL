...
echo "Total time taken for table creation: $elapsed_time seconds."
...
load_data() {
    ...
    #     LINES TERMINATED BY '\n';
    # "
    echo "LOAD DATA LOCAL INFILE 'E:\\\\Documents\\\\BDMA\\\\ULB\\\\Data Warehouses\\\\project1\\\\DSGen-software-code-3.2.0rc1\\\\data\\\\1_nulls\\\\$table_name.csv' 
        INTO TABLE $table_name 
        FIELDS TERMINATED BY ',' 
        LINES TERMINATED BY '\n';"
