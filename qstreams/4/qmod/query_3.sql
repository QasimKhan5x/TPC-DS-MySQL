...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Electronics','Sports','Music') and
          i_class in ('portable','archery','classical')
         )
      or (i_category in ('Shoes','Children','Men') and
          i_class in ('athletic','toddlers','pants') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (7,11,9,3,5,4) and
       d_year = 2002 and
       ca_state in ('VA','PA','NJ'
                   ,'KY','NC','TN','OH')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('olive','puff','moccasin'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 6
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('VA', 'MI', 'KS')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NV', 'OK', 'LA')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Oakwood'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  39462
   and ib_upper_bound   <=  39462 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Campbell County','Seminole County','Cumberland County','Clay County','Hunt County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '10363','46454','24197','34812','45147','43355',
                          '59634','40567','26363','64463','44414',
                          '78849','70615','54542','79050','84157',
                          '69056','27478','48530','97849','49900',
                          '36786','76212','63735','28397','51174',
                          '50048','11650','49410','82461','34039',
                          '77229','57087','74232','69373','69933',
                          '20744','91364','25420','27051','74417',
                          '73799','33959','19110','31125','63997',
                          '26108','30690','38523','99265','83089',
                          '29598','68665','67290','15883','47534',
                          '39617','96065','21421','80169','76143',
                          '81495','86269','40423','83371','59105',
                          '75429','53752','39186','65948','16837',
                          '43504','72469','12430','98592','94092',
                          '54192','23015','29399','14788','29660',
                          '83398','43912','16418','81606','55288',
                          '60466','15563','81220','27909','47603',
                          '65057','59861','83466','65378','90574',
                          '14345','16443','92593','13399','83135',
                          '80962','16392','41175','28985','55371',
                          '92927','52276','41334','90652','80508',
                          '15729','39608','10700','38544','85158',
                          '84888','65874','16663','20028','26333',
                          '32223','92685','15991','81236','43554',
                          '66396','70659','38172','97293','43679',
                          '30522','33711','67841','24213','84928',
                          '88649','81953','47409','61144','96536',
                          '45193','68362','97634','30776','83298',
                          '45635','83187','78375','45386','32568',
                          '90764','96381','44392','93997','47526',
                          '50236','60318','50230','74643','51782',
                          '24585','55960','86143','39240','30156',
                          '60825','30312','81584','95517','50125',
                          '35866','34729','43059','13576','70429',
                          '42675','26290','51365','32090','81139',
                          '21317','53614','78527','38379','42562',
                          '55719','67795','33261','90155','10136',
                          '62115','75492','32816','98049','61141',
                          '58958','83246','41468','79686','62092',
                          '59397','83663','26483','64650','95149',
                          '92164','11652','81475','60484','33515',
                          '81390','82659','63013','80097','34977',
                          '80379','66080','59032','66231','29848',
                          '61979','68359','46212','66263','60949',
                          '27498','18548','97562','68462','54177',
                          '35504','68009','59238','28021','47255',
                          '94278','38744','97698','29911','54831',
                          '21306','11485','52183','78567','19657',
                          '20555','57420','68076','84302','75741',
                          '59275','39660','92792','11051','58765',
                          '33529','66806','92963','73407','41448',
                          '71621','79215','50724','12140','93413',
                          '47321','79339','95350','53637','40555',
                          '61097','12679','58796','13511','95718',
                          '51502','58452','85128','71890','75629',
                          '19730','29555','41384','71679','37819',
                          '94785','84072','58426','72860','69487',
                          '72457','45792','36690','58224','44094',
                          '90398','63592','84844','35171','81818',
                          '93969','66041','87443','15574','46931',
                          '42250','89471','43685','83828','27677',
                          '83923','66940','68672','56491','25551',
                          '72445','16652','30638','18032','16136',
                          '80606','13127','30640','93786','70408',
                          '41742','18514','33957','53117','61965',
                          '49487','78589','65823','73249','10023',
                          '71978','38588','79065','62478','52184',
                          '39306','48696','29309','16809','62749',
                          '17589','15389','94016','52287','34677',
                          '45020','43906','45759','21837','51013',
                          '33932','25101','55108','97868','37545',
                          '18447','50474','32453','68365','10939',
                          '59826','71319','50411','66156','12773',
                          '32744','54980','21127','45548','18896',
                          '24828','53903','43443','42841','63915',
                          '80168','33714','27570','57491','54038',
                          '77537','51021','27248','81546','57513',
                          '37897','30373','35109','70361','89920',
                          '84938','77805','69126','17978')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and i_manufact_id in (919,739,829,701)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 56881 and 56881+28800 
...
select  i_item_id
 ...
 and i_manufact_id in (430,489,940,868)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Midway','Fairview','Oak Grove','Fairview','Midway') 
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 783 and 783+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'ivory' or i_color = 'spring') and 
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'lime' or i_color = 'smoke') and 
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-01-29','2002-08-31','2002-11-21')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 72 and 72+10 
             or ss_coupon_amt between 402 and 402+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 100 and 100+10
          or ss_coupon_amt between 4632 and 4632+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 171 and 171+10
          or ss_coupon_amt between 11032 and 11032+1000
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('navajo','cyan','papaya','rosy','azure','violet') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 137655
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 159528
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 42367
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 179888
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 16479
            then (select avg(ss_ext_list_price)
                  from store_sales
