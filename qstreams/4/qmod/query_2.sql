with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('spring','blush','lavender'))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-02-03','1999-09-21','1999-11-09')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 148 and 148+10 
             or ss_coupon_amt between 13884 and 13884+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 8 and 8+10
          or ss_coupon_amt between 5061 and 5061+1000
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '60724','87854','56412','73919','96614','61805',
                          '12561','25042','63544','41670','48755',
                          '79897','91453','57423','91781','81853',
                          '27803','19922','97507','38178','42333',
                          '64148','64762','97514','38682','81970',
                          '52698','80545','83562','79861','26148',
                          '26174','37178','65350','56899','98534',
                          '52939','70185','49923','31986','90611',
                          '16793','16885','50278','78506','60907',
                          '92389','96828','65507','74204','82751',
                          '83110','94803','80359','85807','70680',
                          '58383','33314','35518','98524','42538',
                          '87230','93039','99685','76521','19036',
                          '86848','94029','97132','45132','43290',
                          '51732','91918','42891','92456','58629',
                          '73378','50067','40678','73088','55324',
                          '98405','30980','22409','72516','87805',
                          '19406','73279','10209','34023','28951',
                          '97530','93542','33513','55695','15077',
                          '72168','47993','54157','89786','47284',
                          '37488','60388','44536','43316','22511',
                          '71478','19029','97231','28523','86999',
                          '81286','47589','14466','47146','28035',
                          '12712','21260','50821','37335','83972',
                          '49967','17962','13318','60929','23720',
                          '24189','40724','59806','44921','41371',
                          '51980','95234','29959','76205','61249',
                          '36920','53634','60054','50161','80487',
                          '32900','80042','82391','93821','20420',
                          '65362','98339','20940','76182','44178',
                          '12215','31235','83735','91802','85507',
                          '98740','25693','12287','58244','11539',
                          '51160','86201','43442','59766','19588',
                          '17615','86132','17898','90627','24212',
                          '82972','92736','50889','53872','46563',
                          '49901','34527','42102','39072','89423',
                          '80990','62772','48369','74890','75051',
                          '70686','54328','99314','28533','69344',
                          '57308','31858','79984','65552','98945',
                          '99624','35404','33985','76456','62624',
                          '52402','59752','43135','38868','73996',
                          '52443','83416','56779','46512','53907',
                          '26729','76770','29030','68578','18742',
                          '63545','93266','39199','59497','57321',
                          '25313','15118','98758','84895','74995',
                          '85143','86460','45793','93154','77348',
                          '15381','37026','99252','31656','35633',
                          '62895','41512','10477','33807','27421',
                          '16287','67703','80878','76244','64599',
                          '23083','66818','97955','15881','86927',
                          '85785','88511','32031','74157','61753',
                          '37762','73108','62242','87761','39816',
                          '78502','35766','71523','45612','94999',
                          '84579','53370','27940','90509','23028',
                          '54786','19679','88577','95187','93197',
                          '56649','94754','56246','37245','79880',
                          '77718','67408','25907','81281','54747',
                          '81968','87078','55310','59158','21303',
                          '90214','39954','27465','15235','92202',
                          '89501','83886','52886','99969','31590',
                          '52645','79651','50930','35139','67741',
                          '38352','82967','56782','38697','42265',
                          '34812','54723','72299','97238','64872',
                          '38509','70651','81582','24426','18378',
                          '87056','36984','49006','98628','20153',
                          '40179','55569','87521','43542','20417',
                          '42066','37643','87518','96762','51245',
                          '81086','93979','46870','24667','94373',
                          '26778','15073','35120','12079','11160',
                          '32398','73552','19997','84806','12179',
                          '11109','86564','27827','26118','60855',
                          '23732','99741','90171','94573','51591',
                          '67315','67189','76937','24803','17513',
                          '67944','33364','18687','98871','46051',
                          '75025','46186','83684','70669','19218',
                          '29416','69746','12323','66522','56312',
                          '50688','30288','53302','98429','57149',
                          '14332','68478','86840','57040','42762',
                          '88047','87076','33407','91510','97668',
                          '42732','42727','22447','30736')
     intersect
      select ca_zip
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Custer County','Gladwin County','Upshur County','Snyder County','Sheridan County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and i_manufact_id in (597,395,654,86)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Greenville'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  10118
   and ib_upper_bound   <=  10118 + 50000
...
select  i_item_id
 ...
 and i_manufact_id in (819,736,782,770)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('blanched','slate','saddle','rosy','yellow','purple') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 165136
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 1513
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 92004
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 174164
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 15560
            then (select avg(ss_ext_tax)
                  from store_sales
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,6,8,7,4,9) and
       d_year = 2000 and
       ca_state in ('NE','OK','ND'
                   ,'TX','NC','VA','VT')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('AK', 'SD', 'OH')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AR', 'WV', 'VA')
 ...
 where i_manufact_id between 739 and 739+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'lavender' or i_color = 'peru') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Oak Grove','Midway','Fairview','Fairview','Midway') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Music','Children','Sports') and
          i_class in ('pop','infants','basketball')
         )
      or (i_category in ('Men','Electronics','Women') and
          i_class in ('shirts','cameras','maternity') 
        ))
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 51384 and 51384+28800 
