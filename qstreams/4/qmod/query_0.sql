...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('almond','indian','antique','chiffon','mint','medium') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Midway','Oak Grove','Fairview','Midway','Fairview') 
...
select  
 ...
 where
  ...
  ca_county in ('Colbert County','Lincoln County','Appling County','Fairfax County','Eureka County') and
...
select  i_item_id
 ...
 and i_manufact_id in (843,822,981,800)
...
where 
	...
	and d_date between cast('2000-01-13' as date) 
				and (cast('2000-01-13' as date) + INTERVAL 30 DAY)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 163 and 163+10
          or ss_coupon_amt between 7110 and 7110+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 146 and 146+10
          or ss_coupon_amt between 6896 and 6896+1000
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 6529 and 6529+28800 
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 36094
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 54339
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 69018
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 44607
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 4037
            then (select avg(ss_ext_tax)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Shoes','Men','Home') and
          i_class in ('mens','pants','furniture')
         )
      or (i_category in ('Jewelry','Electronics','Books') and
          i_class in ('bracelets','dvd/vcr players','science') 
        ))
 ...
 where i_manufact_id between 821 and 821+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'blanched' or i_color = 'chocolate') and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '26844','23531','91628','39143','68470','70861',
                          '71354','94336','44001','63353','14741',
                          '21797','11054','81851','95632','93042',
                          '43279','22868','28912','68684','93771',
                          '74648','16498','48611','83828','56967',
                          '97333','96285','13761','57593','43075',
                          '24436','25299','23243','19841','11791',
                          '46859','12940','56161','20508','47484',
                          '31680','87097','60636','79442','37731',
                          '23024','23538','86132','74423','12389',
                          '22875','45611','41611','71276','31409',
                          '35707','10243','85227','40874','13138',
                          '72542','85269','97866','31383','69134',
                          '87644','73858','11083','71814','62992',
                          '10115','18431','96456','38627','38060',
                          '62135','61144','48928','14460','53591',
                          '40738','86381','57450','37074','78756',
                          '23248','60696','38238','63776','18167',
                          '11294','35609','59587','97013','64977',
                          '18739','45330','35174','62811','16798',
                          '50010','77419','11565','69364','65073',
                          '82204','12099','97780','25316','45211',
                          '62680','53261','23356','44526','21053',
                          '59830','11373','18665','60093','80571',
                          '20567','86169','33825','76098','96220',
                          '86531','65407','85244','39913','15177',
                          '14467','71709','52663','36377','13043',
                          '85449','81262','72134','90308','99795',
                          '62569','66998','58143','58202','35025',
                          '93992','10948','16587','21440','48848',
                          '38730','12891','34063','68386','24727',
                          '34646','15304','91045','25154','72182',
                          '36212','17793','24079','13569','48212',
                          '28874','73683','89126','96625','23673',
                          '94288','49248','28319','14683','25708',
                          '28155','19226','80736','62367','81330',
                          '44101','78592','44572','35357','97631',
                          '32833','98925','31920','29655','81683',
                          '17505','79077','58549','93948','11674',
                          '82738','24840','13757','16967','15920',
                          '22496','34845','21890','81093','50609',
                          '61651','53991','76898','90789','12075',
                          '11551','20745','55397','16808','49351',
                          '35939','75158','83328','39202','21946',
                          '52570','26762','61775','53353','46831',
                          '12338','87170','83565','29202','87380',
                          '15264','37607','62008','82248','46657',
                          '26192','29432','29180','20487','91593',
                          '24616','33174','42950','37403','73048',
                          '15685','71635','61720','30902','60428',
                          '66776','22747','10125','19874','52832',
                          '31321','26790','10619','14336','41518',
                          '13001','79608','52777','61852','89570',
                          '61088','86378','33884','72889','20410',
                          '50473','59254','68291','14604','74948',
                          '28553','43855','12802','94048','30639',
                          '91419','18554','11976','31252','73352',
                          '52444','28742','23899','71244','58557',
                          '26685','56276','47786','27844','64918',
                          '29255','44533','52624','67804','29914',
                          '87996','38472','44055','38458','10041',
                          '41327','19817','38099','25840','28232',
                          '36986','84094','33112','10918','22262',
                          '66299','79168','41190','78899','77343',
                          '37359','27334','95893','54503','16195',
                          '77119','72177','65227','27427','26774',
                          '13803','43764','68438','19281','60266',
                          '55296','14049','12107','28712','13544',
                          '89947','40403','65717','33100','22398',
                          '68834','35779','15441','77242','37579',
                          '50073','54126','80057','60086','60159',
                          '86185','36688','13725','39156','61226',
                          '72280','63552','62778','93589','40043',
                          '66774','17164','76070','59107','74691',
                          '72485','20140','12476','22930','57517',
                          '81158','20162','46430','63081','38695',
                          '26895','67489','45400','37090','16376',
                          '84165','24275','83921','44290','17869',
                          '71924','79179','41501','15169','16510',
                          '20861','67583','42866','11367')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-07-04' as date) and (cast('1999-07-04' as date) + INTERVAL  60 DAY)
 and i_manufact_id in (25,620,618,465)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 1998 AND 1998 + 2) t5
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Wilson'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  53428
   and ib_upper_bound   <=  53428 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('peach','brown','grey'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 6
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,1,5,11,2,10) and
       d_year = 2000 and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('VA', 'IL', 'IN')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NC', 'WI', 'MA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NE', 'NV', 'CO')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-07-09','1998-09-29','1998-11-08')))
