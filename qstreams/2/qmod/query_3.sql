...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Men','Shoes','Jewelry') and
          i_class in ('pants','mens','consignment')
         )
      or (i_category in ('Books','Music','Electronics') and
          i_class in ('home repair','rock','wireless') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,6,11,1,2,8) and
       d_year = 1998 and
       ca_state in ('NE','NV','MO'
                   ,'FL','OK','IN','ND')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('aquamarine','tan','chocolate'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 4
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Riverside'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  36451
   and ib_upper_bound   <=  36451 + 50000
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 1999 AND 1999 + 2) t4
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Osceola County','Jones County','Nolan County','Menard County','Avoyelles Parish') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '49058','79618','20612','72706','96918','25363',
                          '51632','72593','32162','36025','64906',
                          '50226','65155','76598','32983','36896',
                          '90040','14247','13712','11052','60411',
                          '29471','53302','91960','98792','96783',
                          '27854','46193','84032','15991','48349',
                          '62547','86603','74091','74511','71251',
                          '68637','92695','48477','95336','33594',
                          '92575','96096','46371','64847','17783',
                          '67310','17805','25267','48685','51912',
                          '15562','19205','31854','59935','23967',
                          '34780','75226','21706','55739','13092',
                          '17089','54621','58540','38051','77041',
                          '26205','53632','56692','61546','45115',
                          '57965','59338','64546','40808','59557',
                          '26445','96239','87078','59137','24906',
                          '10711','32842','24417','53624','70270',
                          '53443','17391','73236','18628','50418',
                          '46288','66855','33629','52824','55357',
                          '83003','83971','10760','49989','82620',
                          '55136','36943','65857','12563','62527',
                          '74950','48846','32418','46729','83161',
                          '13513','43764','20838','96162','75409',
                          '75248','42587','19811','24396','93182',
                          '39727','29664','58891','66705','12429',
                          '77748','55902','55541','63198','80005',
                          '49033','63601','15410','78833','88339',
                          '24121','58315','25702','91377','78758',
                          '56507','43386','26998','97393','69520',
                          '25579','10466','87121','72346','94889',
                          '62195','34029','53671','57991','45310',
                          '56855','38426','93723','17493','79354',
                          '52538','83637','63150','54175','65413',
                          '69954','15401','35859','47123','22282',
                          '93539','42811','91250','57843','69574',
                          '71458','71160','81244','67164','21095',
                          '36941','82506','50907','51799','80136',
                          '94459','86332','98418','97266','16065',
                          '31768','82289','79885','62828','25969',
                          '73864','91078','77933','45231','56140',
                          '98879','28822','65341','33140','19255',
                          '80075','94964','48264','67654','85189',
                          '46733','68229','91801','88522','63440',
                          '55384','64636','59452','67376','43924',
                          '97865','11369','54425','42037','62478',
                          '49109','77037','79893','90031','42912',
                          '98720','49886','82859','10376','34114',
                          '57284','90202','25262','88960','10512',
                          '30332','25270','63257','23412','32194',
                          '64692','33136','76300','58064','23508',
                          '45277','75145','90711','81140','32313',
                          '41765','48517','36045','76885','34475',
                          '28758','20782','51539','45315','25352',
                          '20925','60088','47000','20433','47146',
                          '76629','55231','51299','15248','23441',
                          '94283','59581','90409','95355','57634',
                          '56876','29298','15313','24887','11063',
                          '65382','23615','82487','15728','20422',
                          '77500','50954','61994','29466','70248',
                          '74368','41111','92681','95738','41657',
                          '58142','29949','40929','51880','36411',
                          '89558','99813','85768','95362','41966',
                          '76898','34576','83977','97873','85012',
                          '91154','76305','48853','28871','59121',
                          '47354','52415','34806','70971','86501',
                          '17353','33341','11348','71123','87784',
                          '77437','48236','28672','69160','19836',
                          '96206','54512','40149','37419','54418',
                          '80513','86607','33116','59589','28731',
                          '55235','98023','67716','13064','90688',
                          '50165','33826','31252','75841','96499',
                          '90760','55919','42855','54702','56384',
                          '49308','58062','52395','34959','54540',
                          '26969','56260','98622','86369','44235',
                          '21987','76267','66205','59871','76111',
                          '49430','42615','23589','35914','66536',
                          '92933','33336','22654','84766','58916',
                          '16926','39213','41861','36937','93136',
                          '57862','34663','42356','91854','24287',
                          '84473','16915','44578','83366')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and i_manufact_id in (951,884,906,734)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 3450 and 3450+28800 
...
select  i_item_id
 ...
 and i_manufact_id in (305,926,28,279)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 where i_manufact_id between 893 and 893+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'tomato' or i_color = 'sienna') and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-06-06','2001-08-23','2001-11-22')))
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 175 and 175+10
          or ss_coupon_amt between 3034 and 3034+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 122 and 122+10
          or ss_coupon_amt between 11513 and 11513+1000
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('forest','maroon','orange','bisque','grey','blush') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 3184
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 77665
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 45210
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 24981
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 19440
            then (select avg(ss_ext_list_price)
                  from store_sales
