with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('azure','thistle','white'))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-03-07','2002-10-20','2002-11-23')))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 163 and 163+10
          or ss_coupon_amt between 13263 and 13263+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 54 and 54+10
          or ss_coupon_amt between 12822 and 12822+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 38 and 38+10
          or ss_coupon_amt between 14372 and 14372+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 92 and 92+10
          or ss_coupon_amt between 13894 and 13894+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 150 and 150+10
          or ss_coupon_amt between 11512 and 11512+1000
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '62945','80570','83271','72982','67420','76894',
                          '45641','87255','93159','89404','94609',
                          '88872','63245','72313','15524','64563',
                          '58589','50490','90503','13468','74202',
                          '31136','61019','96206','90994','70087',
                          '78450','68116','10957','65432','85065',
                          '83928','97377','68714','90604','41420',
                          '89192','11094','14061','20659','80524',
                          '41340','77938','37876','74208','99228',
                          '67341','16408','43104','23419','63827',
                          '46642','75076','10631','87641','24657',
                          '23848','79996','96403','97121','82084',
                          '42942','82864','13044','38733','21313',
                          '31615','45389','33832','51029','55136',
                          '38235','92277','40960','90499','99006',
                          '10940','35201','22840','95318','46410',
                          '88564','10210','32943','98916','93447',
                          '70491','85371','92283','45101','54844',
                          '22059','45462','27968','77427','87719',
                          '30268','53408','77651','25825','85905',
                          '51546','83685','33757','62192','39409',
                          '50746','92784','22832','26360','18859',
                          '19095','54470','41779','78852','53705',
                          '91142','82384','35352','25986','59475',
                          '35874','65490','48775','20156','16601',
                          '81245','77764','92167','61653','99251',
                          '17410','98592','14289','56870','95131',
                          '86015','35004','59518','18012','87488',
                          '30315','10475','33452','52100','64227',
                          '39743','32845','89351','53618','85396',
                          '52139','41357','51224','24678','74014',
                          '59173','36145','53967','11439','61640',
                          '74402','94768','40632','95109','61475',
                          '88293','63601','20973','31534','34047',
                          '36139','16348','73944','92506','55446',
                          '58503','86750','12786','37719','26627',
                          '42790','41182','41217','24905','61235',
                          '59342','37756','93030','95044','73672',
                          '74611','24298','27878','18857','57858',
                          '84298','11149','28338','85596','16394',
                          '38057','61058','67856','44191','49201',
                          '85388','76092','72307','21483','21628',
                          '82885','15610','26911','97926','60913',
                          '19297','85610','76705','50115','96747',
                          '92576','34428','68985','45215','39017',
                          '92709','90556','15656','46430','47064',
                          '54710','68898','14162','57569','93281',
                          '23274','87435','54843','14149','84767',
                          '98711','90744','69859','23862','96675',
                          '48190','90463','41977','15464','82431',
                          '64410','17701','76414','44308','22231',
                          '69601','52600','30656','65439','39595',
                          '58022','90713','38768','20246','76572',
                          '79542','65236','57091','39091','25541',
                          '47916','72180','75635','96829','55751',
                          '43939','51976','32198','47110','72882',
                          '30646','11635','39803','36826','26866',
                          '98804','15157','93387','16229','28201',
                          '95162','31062','32226','35510','64546',
                          '96977','72670','33486','21286','77766',
                          '46930','98540','61302','22684','22680',
                          '60075','16891','80719','27049','86949',
                          '48575','67947','19503','30516','34244',
                          '14066','19098','64289','66188','13768',
                          '76579','90625','96323','14429','46927',
                          '26950','86679','89863','98840','92462',
                          '74960','32540','93123','79295','58248',
                          '18489','70891','75322','43902','22346',
                          '34381','66955','28616','49225','54587',
                          '81218','55503','25444','59294','80072',
                          '63957','64769','93730','94726','92877',
                          '62732','61856','62691','73709','92458',
                          '56485','41215','14864','60756','31159',
                          '25874','39983','77599','79151','55882',
                          '42291','68390','36620','64862','22290',
                          '82095','83182','68552','74261','88945',
                          '43724','18879','16225','62245','29354',
                          '56082','16179','85973','54850','63531',
                          '62275','74877','71909','84340','76457',
                          '86886','14535','82931','22958')
     intersect
      select ca_zip
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Nobles County','Christian County','Osceola County','Sarpy County','Calhoun County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 1998 AND 1998 + 2) t1
 ...
 from (select cs_quantity*cs_list_price sales
      ...
      select ws_quantity*ws_list_price sales
       ...
       where d_year = 1998 
         ...
         and ws_bill_customer_sk in (select c_customer_sk from best_ss_customer)) t3 
 limit 100;
with frequent_ss_items as
 (select substr(i_item_desc,1,30) itemdesc,i_item_sk item_sk,d_date solddate,count(*) cnt
  from store_sales
 ...
 from (select c_last_name,c_first_name,sum(cs_quantity*cs_list_price) sales
      ...
      select c_last_name,c_first_name,sum(ws_quantity*ws_list_price) sales
       ...
       group by c_last_name,c_first_name) t5 
...
select  i_item_id
 ...
 and i_manufact_id in (431,32,350,649)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Summit'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  51294
   and ib_upper_bound   <=  51294 + 50000
...
select  i_item_id
 ...
 and i_manufact_id in (856,730,990,718)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('frosted','bisque','indian','maroon','drab','aquamarine') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 64823
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 56078
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 94281
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 8983
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 53691
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (6,11,10,5,7,3) and
       d_year = 2002 and
       ca_state in ('TX','AL','IL'
                   ,'FL','MN','KY','NC')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_country = 'United States'
  and ca_state in ('AL', 'VA', 'MO')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'MT', 'NE')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Children','Books','Shoes') and
          i_class in ('newborn','travel','kids')
         )
      or (i_category in ('Women','Jewelry','Men') and
          i_class in ('maternity','costume','accessories') 
        ))
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 11475 and 11475+28800 
