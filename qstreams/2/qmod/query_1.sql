with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-07-12','1998-08-08','1998-11-10')))
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 42368 and 42368+28800 
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Union'
   ...
   and ib_lower_bound   >=  36871
   and ib_upper_bound   <=  36871 + 50000
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast('1998-03-05' as date) - INTERVAL 30 DAY)
                and (cast('1998-03-05' as date) + INTERVAL 30 DAY) 
 group by
    w_state,i_item_id
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MN', 'TN', 'AR')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NE', 'KS', 'UT')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ND', 'PA', 'CO')
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 135 and 135+10
          or ss_coupon_amt between 15561 and 15561+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 151 and 151+10
          or ss_coupon_amt between 15699 and 15699+1000
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 820 and 820+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'magenta' or i_color = 'thistle') and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '88859','72984','40769','94212','87305','80902',
                          '61977','87189','29222','82279','87041',
                          '35585','43481','80710','31911','70385',
                          '70891','18441','38762','70313','48521',
                          '48855','98781','20323','84399','13171',
                          '66345','75488','59159','20468','92162',
                          '10980','97883','81834','23022','53503',
                          '58043','87463','78672','69145','47418',
                          '64877','26105','63466','70474','83508',
                          '89760','13428','99658','16153','48143',
                          '65323','35437','47304','72128','46617',
                          '36903','56558','36802','84248','42789',
                          '22175','41179','24286','67973','28009',
                          '53680','67307','33097','43708','12895',
                          '68400','96333','50718','95383','20337',
                          '19256','32889','99307','13057','70221',
                          '80128','91230','60496','24229','45453',
                          '57211','74448','80320','89400','78976',
                          '12455','29764','11407','91844','20308',
                          '55573','21203','93549','81503','19512',
                          '48137','90600','31160','13535','14844',
                          '59674','64159','37702','17069','99566',
                          '82408','25985','37856','14314','82774',
                          '87774','34991','78753','88313','61576',
                          '43295','11318','26861','70901','34807',
                          '72158','80855','94843','11917','80703',
                          '28198','62455','46808','74512','51530',
                          '29527','72545','35784','34479','27102',
                          '77173','70817','79383','83530','22256',
                          '52278','95348','34624','61825','17384',
                          '30345','79211','79533','53667','26316',
                          '51558','26655','17144','16247','11232',
                          '13769','44538','95121','39132','25307',
                          '91379','83522','39759','29411','87110',
                          '86179','17723','36598','18925','85821',
                          '81754','31648','31935','21334','60583',
                          '98590','16466','74358','62992','19664',
                          '35027','97876','57999','98056','40701',
                          '69190','17697','44212','93348','21341',
                          '60808','26470','29687','12312','10134',
                          '76686','72748','45137','42223','70611',
                          '85530','83241','26988','17081','16439',
                          '84448','47258','56358','52619','98588',
                          '34226','29817','33386','90633','63532',
                          '21082','17554','76365','50825','24962',
                          '26549','36935','87683','26940','74674',
                          '54876','64584','79657','45733','34636',
                          '36145','53464','21938','96436','61094',
                          '36127','81660','89817','83459','99027',
                          '93424','34672','53226','38837','35664',
                          '30089','68712','53142','92500','64778',
                          '38592','11929','14562','31927','32126',
                          '10333','40462','98643','83378','99035',
                          '21707','97663','58059','50268','24239',
                          '28671','78667','93104','30106','75587',
                          '32807','14766','29436','81664','67621',
                          '51009','55837','82028','89733','59867',
                          '85422','84398','22976','27235','68182',
                          '66717','98911','65488','31322','82420',
                          '89721','83199','98361','42294','31106',
                          '14014','43482','96343','82769','24106',
                          '32396','14511','84476','60752','63991',
                          '93680','61314','85453','33514','37016',
                          '78952','78192','39465','19567','49943',
                          '39737','27104','94007','16988','28411',
                          '71063','17048','79399','95807','28831',
                          '87323','71289','86772','16725','33258',
                          '73369','62392','54791','10754','46615',
                          '32589','46156','98273','37905','99265',
                          '39111','89841','86463','83584','39100',
                          '51087','21879','98604','13075','99196',
                          '48082','15120','46219','28358','40269',
                          '94652','63499','74692','55003','46013',
                          '59083','32962','16739','61834','68997',
                          '75131','33062','74484','27351','38492',
                          '47239','21824','13965','63480','35253',
                          '99504','80625','94489','26276','69138',
                          '93252','12183','89669','94213','63159',
                          '35967','76309','85633','81097','63598',
                          '26002','96931','64786','97165')
     intersect
      select ca_zip
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 2000 AND 2000 + 2) t0
...
select  i_item_id
 ...
 and i_manufact_id in (415,325,1,355)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,6,4,3,10,11) and
       d_year = 2000 and
       ca_state in ('VA','CO','NY'
                   ,'NC','MO','TX','WY')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 36269
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 63436
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 41070
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 79430
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 66253
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-03-01' as date) and (cast('2001-03-01' as date) + INTERVAL  60 DAY)
 and i_manufact_id in (861,670,703,852)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('mint','blush','antique','forest','lemon','steel') and
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Home','Electronics','Children') and
          i_class in ('mattresses','portable','school-uniforms')
         )
      or (i_category in ('Music','Women','Shoes') and
          i_class in ('country','maternity','kids') 
        ))
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Bolivar County','Iroquois County','Sterling County','Hamilton County','Thomas County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('burnished','dodger','firebrick'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 6
