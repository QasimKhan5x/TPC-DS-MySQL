...
select  
 ...
 where
  ...
  ca_county in ('Adams County','Colbert County','Sheridan County','Elbert County','Cache County') and
...
select  i_item_id
 ...
 and d_date between cast('1998-01-24' as date) and (cast('1998-01-24' as date) + INTERVAL  60 DAY)
 and i_manufact_id in (709,959,974,739)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 63 and 63+10 
             or ss_coupon_amt between 11495 and 11495+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 34 and 34+10
          or ss_coupon_amt between 10746 and 10746+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 30 and 30+10
          or ss_coupon_amt between 6509 and 6509+1000
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 39448 and 39448+28800 
...
select case when (select count(*) 
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 33808
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 38078
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 20765
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 7621
            then (select avg(ss_ext_tax)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Sports','Music','Shoes') and
          i_class in ('optics','rock','mens')
         )
      or (i_category in ('Men','Electronics','Books') and
          i_class in ('sports-apparel','memory','mystery') 
        ))
 ...
 where i_manufact_id between 752 and 752+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'floral' or i_color = 'papaya') and 
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '81077','83924','71535','80284','94169','88793',
                          '36121','73804','54097','81074','25619',
                          '20839','89768','17709','20335','85570',
                          '50089','13727','59099','27503','80104',
                          '37073','91469','78911','49020','65360',
                          '55324','31890','14371','78005','49327',
                          '37276','68757','84833','57788','77791',
                          '65758','62418','76615','45302','78011',
                          '17413','80822','70223','70940','50275',
                          '53427','96632','60903','30605','69845',
                          '41842','86057','18961','51724','88277',
                          '54671','29203','31892','73396','38047',
                          '69868','14268','85683','37178','56786',
                          '84543','22022','45014','81189','27446',
                          '47976','83973','99211','23323','20280',
                          '54310','23607','48666','78728','77998',
                          '48110','46031','32847','34183','20576',
                          '30709','75245','26954','73797','40786',
                          '31292','57099','25171','41085','55037',
                          '16358','37713','53717','43588','26780',
                          '84645','58549','79493','77536','85330',
                          '55105','19702','19282','12554','59808',
                          '24711','83207','70010','50396','35716',
                          '21398','49188','40706','69620','25784',
                          '32653','15214','17088','26566','72230',
                          '86571','94032','38108','72732','49325',
                          '72621','11886','86552','65603','74209',
                          '42679','75656','61670','16762','85539',
                          '47822','27965','69906','87232','62899',
                          '16308','25221','87157','25138','69678',
                          '68299','23193','24398','47072','71295',
                          '28434','67669','58276','73510','65293',
                          '76067','48602','20690','47678','46104',
                          '18376','19309','67359','76286','12990',
                          '15373','42806','16259','37720','19267',
                          '35188','26649','86658','20716','52574',
                          '28847','10505','12314','80768','89600',
                          '55812','26810','55369','96460','81430',
                          '60462','12440','82086','41723','93888',
                          '75600','83225','16881','32029','14209',
                          '23309','69656','85548','82324','48772',
                          '59687','54776','60844','81729','32772',
                          '88345','96229','19178','99865','59500',
                          '81809','46919','63038','53645','12293',
                          '22885','28629','20113','69325','36779',
                          '50788','84178','81037','56753','14239',
                          '58176','29031','41644','74967','96959',
                          '48503','53508','31227','68914','96614',
                          '25535','70129','44260','68862','74907',
                          '23356','56955','77085','61003','44310',
                          '19671','52021','33588','14549','84457',
                          '22964','61307','86141','55824','12454',
                          '66302','22428','12910','57432','59354',
                          '29946','78019','12503','40178','80614',
                          '54358','20561','72404','74166','55321',
                          '14110','87789','13079','23997','53224',
                          '76401','37204','38716','24177','69834',
                          '85497','38637','36827','54030','90155',
                          '10947','56054','50219','59265','16294',
                          '34010','35865','21329','79881','90279',
                          '95865','41476','76386','52744','19555',
                          '26107','25743','37584','15358','15993',
                          '87599','50810','18451','79832','86660',
                          '12746','49901','95666','52096','23777',
                          '34269','34442','69026','16954','16347',
                          '12206','11467','63852','77520','29074',
                          '37709','16760','25203','17292','64727',
                          '71088','41249','91541','65207','70344',
                          '50152','41193','18172','74519','33752',
                          '75748','39915','53066','25451','40712',
                          '15988','86371','55173','19617','28275',
                          '97757','20194','80495','14287','39193',
                          '60883','81231','32563','80056','31546',
                          '34530','86567','61943','71618','44057',
                          '87676','22642','70518','32431','97826',
                          '55752','72890','45209','39690','43526',
                          '59584','74567','35717','25106','36515',
                          '12092','20577','18712','33681','35213',
                          '50075','87855','29130','83551','91576',
                          '44934','19216','18991','35134')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and i_manufact_id in (929,171,684,226)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 1999 AND 1999 + 2) t5
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Enterprise'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  50376
   and ib_upper_bound   <=  50376 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('navajo','medium','dim'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 1
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast('1999-04-03' as date) - INTERVAL 30 DAY)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (7,12,4,10,8,2) and
       d_year = 1999 and
       ca_state in ('NC','AL','NM'
                   ,'MS','MT','IA','TX')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-01-16','1998-08-16','1998-11-04')))
