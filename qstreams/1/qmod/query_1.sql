with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-07-12','1998-08-08','1998-11-14')))
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 49218 and 49218+28800 
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Highland'
   ...
   and ib_lower_bound   >=  60835
   and ib_upper_bound   <=  60835 + 50000
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 15 and 15+10 
             or ss_coupon_amt between 1992 and 1992+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 143 and 143+10
          or ss_coupon_amt between 7746 and 7746+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 14 and 14+10
          or ss_coupon_amt between 2457 and 2457+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 24 and 24+10
          or ss_coupon_amt between 13027 and 13027+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 138 and 138+10
          or ss_coupon_amt between 5266 and 5266+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 129 and 129+10
          or ss_coupon_amt between 3666 and 3666+1000
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '24669','54673','38531','32699','63316','54390',
                          '25409','14834','48865','22791','75420',
                          '39694','87085','57800','95587','70746',
                          '48272','50257','51258','96002','97270',
                          '54257','67555','27989','55494','38051',
                          '33141','22770','66811','85848','97501',
                          '40154','15729','71479','72220','65964',
                          '84850','69555','93040','81214','73206',
                          '34138','73786','88132','88612','21520',
                          '18369','78045','71932','28866','23731',
                          '70575','88036','95367','68891','46014',
                          '93828','91769','60744','45483','86885',
                          '72594','55484','36882','21885','12244',
                          '27071','96754','57270','62250','30416',
                          '16496','33786','69340','12683','78357',
                          '30542','35202','90667','18992','39825',
                          '61068','42684','38672','40376','21641',
                          '59835','82719','32409','95736','71545',
                          '19112','61352','46246','89041','80811',
                          '84504','37176','81573','79696','44924',
                          '13365','90688','62850','43389','34407',
                          '42502','89799','82521','72788','21464',
                          '40776','23751','20866','61583','85760',
                          '76237','73020','35633','16028','65759',
                          '45530','17325','95460','93097','29696',
                          '87339','39965','94478','13254','27356',
                          '41471','28772','24976','91812','73976',
                          '35920','79620','76329','50622','82859',
                          '29221','81059','45183','55729','99241',
                          '13598','95348','50231','51351','73811',
                          '92053','63920','76635','21377','85490',
                          '65958','65016','35479','81213','22774',
                          '83988','33012','50585','66937','60599',
                          '54903','88311','20591','34584','86839',
                          '16562','65750','36683','87848','49634',
                          '67317','55571','15514','69334','77890',
                          '37720','43902','47469','39535','45246',
                          '33070','66526','35521','95071','31030',
                          '44927','26066','79192','33876','68502',
                          '12627','44855','63207','73199','51380',
                          '14661','55543','34566','58627','28492',
                          '97708','26279','67794','32522','85228',
                          '59624','44747','41468','36035','86114',
                          '41999','49094','36775','17603','92564',
                          '60579','72086','57639','61958','85623',
                          '31241','12257','68515','78777','52054',
                          '81892','36239','15407','73952','40278',
                          '18119','57954','93072','13154','76168',
                          '27266','89445','11416','75611','34327',
                          '20571','43390','21012','90933','30247',
                          '87357','49235','76838','20612','11824',
                          '10205','76426','15988','61462','34012',
                          '36891','88462','25944','96962','46177',
                          '92245','93061','12207','54468','51727',
                          '55359','50642','76543','20291','64598',
                          '26490','26812','35061','87077','61879',
                          '72779','41748','87226','55340','59038',
                          '26834','96612','98900','81395','12185',
                          '66415','34852','41119','79414','51466',
                          '60690','55520','29961','92054','17900',
                          '69729','21330','51983','91779','74141',
                          '78051','21256','75719','97235','45327',
                          '13536','35006','47573','66906','59257',
                          '91651','62330','12465','77606','28430',
                          '85955','48545','49706','26209','57655',
                          '58692','38021','41689','64838','53481',
                          '62178','15994','82397','47102','15761',
                          '97832','22679','20434','74003','15143',
                          '98758','36810','67884','55238','23847',
                          '53451','38595','73231','96894','93576',
                          '89811','26769','20351','98669','49944',
                          '28462','64725','26665','46369','91890',
                          '92115','20804','92514','59842','21734',
                          '94978','12438','26737','92237','19837',
                          '80949','69653','59107','60284','71748',
                          '95976','22842','76852','49502','15238',
                          '32014','95613','40355','67202','25174',
                          '27735','28386','76050','76582','23981',
                          '97001','12728','32997','90044','55695',
                          '28146','45369','78705','33364')
     intersect
      select ca_zip
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 1998 AND 1998 + 2) t0
...
select  i_item_id
 ...
 and d_date between cast('1999-07-17' as date) and (cast('1999-07-17' as date) + INTERVAL  60 DAY)
 and i_manufact_id in (144,522,610,629)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,5,3,6,11,12) and
       d_year = 2000 and
       ca_state in ('IL','NE','MN'
                   ,'VA','TX','MS','OK')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 46711
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 43523
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 38427
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 5137
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 1317
            then (select avg(ss_ext_tax)
                  from store_sales
...
select  i_item_id
 ...
 and i_manufact_id in (949,997,951,680)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('blush','salmon','green','sienna','peach','lime') and
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Books','Shoes','Home') and
          i_class in ('science','mens','kids')
         )
      or (i_category in ('Electronics','Jewelry','Men') and
          i_class in ('camcorders','semi-precious','pants') 
        ))
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Jefferson County','Randolph County','Greene County','Mecklenburg County','Bottineau County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('dodger','grey','wheat'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 3
