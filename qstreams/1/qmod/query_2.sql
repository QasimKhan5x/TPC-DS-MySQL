with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('ghost','goldenrod','maroon'))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-06-08','2000-09-16','2000-11-09')))
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 127 and 127+10
          or ss_coupon_amt between 1131 and 1131+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 55 and 55+10
          or ss_coupon_amt between 6664 and 6664+1000
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '50271','64534','65126','51973','16364','59785',
                          '81108','46110','91234','75289','98031',
                          '48817','20733','83614','14814','74587',
                          '31285','81698','50678','83731','80560',
                          '19083','99470','43011','66740','37150',
                          '60643','90784','52373','15557','63282',
                          '14836','58318','80753','92348','43965',
                          '13475','38931','51725','87022','92097',
                          '26943','41582','25520','23103','78276',
                          '18285','59927','38986','80032','47351',
                          '59763','25036','88355','28738','63101',
                          '25365','46608','51000','72515','51377',
                          '16625','69214','38594','45660','11425',
                          '72478','31420','13904','10880','17270',
                          '51081','14655','95325','28512','25212',
                          '45358','96257','29248','58547','24461',
                          '14776','77932','46207','10864','79127',
                          '61121','90843','18599','19263','84169',
                          '19501','34450','93835','66883','96611',
                          '93031','19815','86090','33671','92156',
                          '74428','94394','90687','41660','32165',
                          '71355','85595','58876','13714','76250',
                          '50042','35345','15499','34888','92738',
                          '15949','30417','33941','25637','86767',
                          '63717','71660','36048','28503','68305',
                          '11231','25513','45815','29756','37194',
                          '67082','65438','40047','99790','35788',
                          '60844','80068','38781','65712','86764',
                          '35225','82987','47934','45628','14608',
                          '86456','12456','39165','76934','16336',
                          '76274','76366','93410','21784','99679',
                          '23604','91802','33850','22324','93362',
                          '10482','73272','57783','34831','72201',
                          '95330','14894','68798','46368','92089',
                          '70588','17603','97891','29213','73584',
                          '24149','10321','95172','96160','28102',
                          '80792','40608','60903','51631','76118',
                          '24497','70431','43106','22260','34126',
                          '90940','69519','18957','22775','19902',
                          '14727','55827','94412','69310','64168',
                          '55114','31283','53735','83305','12266',
                          '15941','48350','46063','13647','26084',
                          '40238','87825','47164','18036','38804',
                          '28293','75497','35170','91008','13390',
                          '16755','31538','97796','35859','91239',
                          '90254','34728','44700','89635','47067',
                          '58190','89138','91948','10124','91736',
                          '77357','17634','68600','63767','86853',
                          '77515','43427','39773','87997','97456',
                          '16621','49252','48259','23187','17560',
                          '94583','68895','46383','18042','61194',
                          '83187','33452','54383','58510','39456',
                          '62089','87144','57064','23659','51240',
                          '96715','96859','28229','89994','73195',
                          '56051','22623','83578','97275','25136',
                          '27081','85906','57735','24896','59748',
                          '60978','84020','35463','68407','36509',
                          '13115','81776','93448','93726','23773',
                          '91169','47902','62655','57561','62691',
                          '86868','57460','33492','91809','48639',
                          '13747','97916','84819','89556','31229',
                          '90536','11954','37479','12876','29812',
                          '15297','33109','84185','81608','48448',
                          '63197','95275','24920','40967','86156',
                          '55327','89901','35504','54991','59166',
                          '46885','56318','77948','59200','22516',
                          '27578','23798','92078','63304','51007',
                          '21498','63156','90070','27586','36896',
                          '19611','58213','68849','34096','73875',
                          '50581','80553','71804','42255','14519',
                          '20887','34521','72673','34084','74596',
                          '23781','10970','87862','92233','62804',
                          '90388','18035','99119','56409','60385',
                          '56385','96093','91808','64653','84779',
                          '20976','12137','95998','99610','42422',
                          '46162','63558','58355','46493','17267',
                          '13896','73943','12934','29798','88035',
                          '23618','97734','37573','17234','58303',
                          '70056','26231','74763','48240','41877',
                          '43594','12176','73416','68381')
     intersect
      select ca_zip
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Marshall County','Coleman County','Hoke County','Leon County','Hill County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and i_manufact_id in (697,838,678,648)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Lakeside'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  26805
   and ib_upper_bound   <=  26805 + 50000
...
select  i_item_id
 ...
 and i_manufact_id in (966,670,807,911)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('drab','midnight','steel','forest','light','metallic') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 45419
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 20068
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 45345
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 10743
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 42738
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (9,6,11,4,1,10) and
       d_year = 1999 and
       ca_state in ('CO','NE','MN'
                   ,'MI','IA','FL','MO')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('ME', 'AR', 'MT')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MS', 'VA', 'ID')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OH', 'PA', 'NH')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Music','Children','Electronics') and
          i_class in ('rock','infants','portable')
         )
      or (i_category in ('Sports','Jewelry','Books') and
          i_class in ('outdoor','estate','home repair') 
        ))
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 32706 and 32706+28800 
