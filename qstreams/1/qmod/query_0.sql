...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 6155
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 30583
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 15335
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 19934
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Men','Electronics','Children') and
          i_class in ('sports-apparel','portable','newborn')
         )
      or (i_category in ('Sports','Home','Books') and
          i_class in ('hockey','rugs','entertainments') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 914 and 914+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'beige' or i_color = 'deep') and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '87956','68828','77903','12502','35284','13746',
                          '88582','24886','60934','38272','73619',
                          '23256','28654','65709','71251','15328',
                          '26728','14036','78984','22956','10544',
                          '34461','19073','13909','19506','46923',
                          '58443','75674','33024','23913','97327',
                          '71905','42048','43824','87595','43609',
                          '49059','56480','97691','93302','70671',
                          '79320','26753','86473','24191','73585',
                          '20533','90117','56530','67194','72069',
                          '44404','45570','66961','48679','61307',
                          '53763','25970','58682','84493','86047',
                          '15957','51041','24725','85178','13248',
                          '38425','46698','28017','13268','83242',
                          '95976','40719','69468','18040','68280',
                          '23568','50614','65032','22752','48684',
                          '19547','16853','91104','99923','57207',
                          '50204','72732','39499','16272','81119',
                          '41314','42821','61511','43457','64720',
                          '37217','20036','13940','72681','60711',
                          '61059','86031','12254','93668','13379',
                          '44159','67702','29250','89794','10380',
                          '19070','52744','24215','39908','52637',
                          '12746','45514','79900','24203','56878',
                          '83562','67937','37031','58999','63913',
                          '27928','59503','52398','65196','45207',
                          '10554','91901','10435','88360','55297',
                          '26037','34267','39439','91671','41111',
                          '28616','75965','58662','16010','63696',
                          '47591','99075','90143','18795','26347',
                          '70542','74508','76661','50340','12421',
                          '11928','74149','51173','11259','17861',
                          '29945','96602','68690','79358','94104',
                          '32001','67309','83095','66356','26008',
                          '63373','39512','44501','75838','41516',
                          '15057','25385','44308','68716','23023',
                          '47886','23332','60314','14614','84360',
                          '16847','84461','70987','63021','72523',
                          '26233','20880','21322','19254','31151',
                          '78382','34895','21838','99739','62209',
                          '93353','16563','25639','15525','59384',
                          '54086','26496','90559','75820','80772',
                          '49574','16183','76316','35017','48608',
                          '85007','54606','85248','56139','27019',
                          '20192','28416','25618','44782','84779',
                          '75415','14895','49000','48434','54031',
                          '74236','53261','89644','18815','16829',
                          '30433','91991','22385','41809','80209',
                          '24178','62436','92260','34850','83519',
                          '78022','80187','21367','85138','92310',
                          '40191','49997','40396','62549','58173',
                          '41480','39314','84832','86097','47928',
                          '25321','89586','81441','57491','76229',
                          '20371','14429','51146','90756','79110',
                          '29695','68346','75826','36366','58724',
                          '62110','44232','18926','71997','17634',
                          '47181','40587','64009','41596','25264',
                          '98122','58686','73953','63219','91211',
                          '46956','43203','80331','67380','76926',
                          '70576','83865','15802','12891','44145',
                          '54052','89476','45736','43882','35105',
                          '14984','42047','36608','11188','59485',
                          '66292','98810','66451','64274','99972',
                          '50108','97901','29460','50087','56091',
                          '83816','40222','15742','54167','64347',
                          '57612','48475','49880','26685','11820',
                          '61439','17292','47743','65292','83570',
                          '72293','15065','99344','10494','53988',
                          '61560','89193','16606','80577','53227',
                          '85483','47219','33969','73451','22755',
                          '31584','62011','99369','98397','99258',
                          '76155','35753','13563','80506','19747',
                          '53300','97678','36423','99140','11078',
                          '63932','77853','14453','44500','52232',
                          '14095','69653','45343','76169','13425',
                          '22665','46911','42358','24683','86524',
                          '35757','14399','39568','73106','20020',
                          '21163','46382','66712','54075','57019',
                          '42155','32493','98379','26812','21517',
                          '52875','31911','83812','55207')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and i_manufact_id in (382,503,278,304)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Florence'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  64621
   and ib_upper_bound   <=  64621 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('dim','thistle','smoke'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 1
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (11,4,1,2,12,8) and
       d_year = 2000 and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-05-06','1999-08-22','1999-11-22')))
