...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Women','Children','Shoes') and
          i_class in ('swimwear','school-uniforms','womens')
         )
      or (i_category in ('Jewelry','Music','Men') and
          i_class in ('jewelry boxes','classical','accessories') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,7,6,2,4,5) and
       d_year = 2001 and
       ca_state in ('AL','WI','MS'
                   ,'CA','ND','IA','IL')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('royal','misty','olive'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 4
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('IN', 'AR', 'NC')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'TX', 'NE')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MO', 'IL', 'IA')
 ...
 from (select cs_quantity*cs_list_price sales
      ...
      select ws_quantity*ws_list_price sales
       ...
       where d_year = 1999 
         ...
         and ws_bill_customer_sk in (select c_customer_sk from best_ss_customer)) t1 
 limit 100;
with frequent_ss_items as
 (select substr(i_item_desc,1,30) itemdesc,i_item_sk item_sk,d_date solddate,count(*) cnt
  from store_sales
 ...
 from (select c_last_name,c_first_name,sum(cs_quantity*cs_list_price) sales
      ...
      select c_last_name,c_first_name,sum(ws_quantity*ws_list_price) sales
       ...
       group by c_last_name,c_first_name) t3 
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Edgewood'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  21651
   and ib_upper_bound   <=  21651 + 50000
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 2000 AND 2000 + 2) t4
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Warrick County','Middlesex County','Ashland County','Saline County','Onslow County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '26064','39136','49610','98700','54959','17217',
                          '44514','34592','67703','40768','99068',
                          '52634','81599','90513','19186','60813',
                          '13864','31610','71596','41943','88586',
                          '87530','70241','52448','51923','57103',
                          '60185','14039','23543','48152','66860',
                          '70838','89620','40468','70060','75602',
                          '44379','27211','17379','74132','15827',
                          '66680','95456','62863','55937','42216',
                          '51985','76438','63074','60564','37480',
                          '26779','47152','85117','44862','98986',
                          '52722','22528','18163','24569','72820',
                          '76306','11291','32871','17535','52337',
                          '62842','82523','92904','98998','85477',
                          '51731','11787','49137','22744','50786',
                          '80924','53643','11871','98641','12983',
                          '22064','33974','79498','92775','57294',
                          '31518','70371','13264','75296','67270',
                          '25846','20807','69365','66629','18223',
                          '22754','26406','27704','12592','13829',
                          '49096','42138','61911','75468','59657',
                          '92292','79744','53822','90601','97823',
                          '58173','43982','48980','33134','50626',
                          '53548','52712','55803','28074','45023',
                          '40363','33585','46918','21799','75290',
                          '77632','89880','42613','95437','14726',
                          '70725','59477','86392','89190','12516',
                          '44899','61889','28390','18530','87156',
                          '13656','13952','60170','65794','76542',
                          '10811','52484','94968','27737','55545',
                          '49283','89049','80587','79878','45722',
                          '20155','75283','38638','99758','16456',
                          '25540','50708','10000','96803','35246',
                          '95479','51667','93657','38198','85259',
                          '96044','50325','83366','66747','10829',
                          '63407','92493','52331','22472','33088',
                          '48193','70691','57814','21868','29037',
                          '73969','29467','38679','99222','77177',
                          '39162','62911','89222','53381','95301',
                          '65744','92212','85935','99151','71213',
                          '96163','51805','63087','21803','68849',
                          '43347','22113','36816','47674','23383',
                          '34352','53555','69132','95269','70431',
                          '59313','74490','79845','96720','60567',
                          '91975','37557','41787','54001','17737',
                          '94852','71992','42254','68449','84425',
                          '39944','98779','65495','78075','34861',
                          '87275','14760','43563','98961','34456',
                          '53097','66486','39124','39587','20533',
                          '99862','77874','31272','26085','63188',
                          '43382','67316','87054','25857','54640',
                          '53965','55668','85256','14215','53764',
                          '86293','34812','33102','92233','86663',
                          '23782','12068','99928','52810','51461',
                          '14645','62339','96829','54044','48831',
                          '59415','98426','62131','66381','64094',
                          '48238','22490','79106','21320','69462',
                          '25394','63754','84739','15221','16225',
                          '70453','43462','49987','60534','30362',
                          '73093','14359','55477','64991','39881',
                          '19366','97226','92505','49080','43294',
                          '36667','77077','18475','49428','27504',
                          '80083','69892','10978','29812','31326',
                          '63157','81025','78061','91403','25355',
                          '37103','76918','45720','56658','23908',
                          '51603','84083','96217','43827','41235',
                          '96218','16247','21916','82223','50683',
                          '33106','91112','62316','56958','55543',
                          '96563','72992','75958','34133','29095',
                          '16052','90788','86281','21698','90266',
                          '23764','46976','26691','21742','48536',
                          '51968','35128','89543','28108','82196',
                          '26340','76173','21422','99003','28749',
                          '98716','12115','69532','19874','64972',
                          '90561','99344','32881','98888','47490',
                          '52027','33404','23604','39758','18471',
                          '66606','28622','61769','91477','72800',
                          '44016','29843','75797','90146','54777',
                          '15080','62687','34577','48834','22751',
                          '42658','54355','36349','88070')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and i_manufact_id in (685,964,973,856)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 18539 and 18539+28800 
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-06-28' as date) and (cast('1998-06-28' as date) + INTERVAL  60 DAY)
 and i_manufact_id in (170,582,92,712)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 899 and 899+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'orchid' or i_color = 'lace') and 
        ...
        (i_category = 'Men' and
        (i_color = 'hot' or i_color = 'turquoise') and
        (i_units = 'Pallet' or i_units = 'Bunch') and
        (i_size = 'extra large' or i_size = 'medium')
        ))) or
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'blue' or i_color = 'forest') and 
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-04-23','2000-10-10','2000-11-21')))
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 2 and 2+10
          or ss_coupon_amt between 7356 and 7356+1000
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('steel','cornflower','dodger','light','papaya','brown') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 39442
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 11154
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 11377
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 3918
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 5397
            then (select avg(ss_ext_list_price)
                  from store_sales
