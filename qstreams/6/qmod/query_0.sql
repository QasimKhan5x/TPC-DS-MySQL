...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast('2000-06-26' as date) - INTERVAL 30 DAY)
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('mint','yellow','chiffon','forest','midnight','deep') and
...
select  
 ...
 where
  ...
  ca_county in ('Eureka County','Scott County','Mahoning County','Franklin city','Blaine County') and
...
select  i_item_id
 ...
 and i_manufact_id in (839,954,711,672)
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 3 and 3+10
          or ss_coupon_amt between 17644 and 17644+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 29 and 29+10
          or ss_coupon_amt between 4947 and 4947+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 101 and 101+10
          or ss_coupon_amt between 14021 and 14021+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 95 and 95+10
          or ss_coupon_amt between 16683 and 16683+1000
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 44973 and 44973+28800 
...
and d_date between '2001-01-22' and 
        (cast('2001-01-22' as date) + INTERVAL 90 DAY)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 221915
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 209456
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 228882
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 173602
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 148379
            then (select avg(ss_ext_list_price)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Women','Children','Men') and
          i_class in ('fragrances','toddlers','sports-apparel')
         )
      or (i_category in ('Shoes','Books','Electronics') and
          i_class in ('kids','self-help','televisions') 
        ))
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '65517','51006','23443','21248','36938','60301',
                          '68563','79562','72594','54711','14820',
                          '11264','12428','69091','41593','80739',
                          '23444','53211','18782','65833','70134',
                          '78292','39820','69717','41931','89891',
                          '80791','48061','40957','65204','41278',
                          '52973','93758','54772','43092','37041',
                          '68164','36811','21804','82933','44061',
                          '71408','87704','68346','12031','48810',
                          '11395','58570','18613','92495','35032',
                          '42723','45864','64965','40286','68656',
                          '96416','28364','94300','57320','16327',
                          '16848','10817','14840','53827','23964',
                          '27158','16839','47281','49284','12245',
                          '22021','85289','76336','39897','10020',
                          '57554','75204','30689','25775','97375',
                          '80702','86553','71298','14891','24235',
                          '60795','71706','30882','83958','28002',
                          '19826','56660','15199','49020','70529',
                          '11757','39573','77375','16029','10940',
                          '51940','13022','11278','16641','60819',
                          '45019','74837','74605','21488','86649',
                          '33363','22670','55591','63252','41008',
                          '68918','52427','10297','73547','49192',
                          '77532','58640','38538','46620','17953',
                          '33423','88855','81902','15357','97518',
                          '56726','55978','53416','16343','61651',
                          '67217','78514','58163','53591','88018',
                          '67242','59115','40763','59406','35888',
                          '68362','70120','17817','48148','50966',
                          '26622','87437','25666','54894','26220',
                          '65418','94221','24804','18051','29097',
                          '67555','66943','99129','13830','95427',
                          '40638','13751','11851','94821','61462',
                          '67424','94586','98586','71308','11783',
                          '87289','56941','28522','56663','30675',
                          '21765','80946','49965','87222','48580',
                          '56962','11221','44148','20105','47865',
                          '65253','37973','37383','15234','88081',
                          '92923','55217','47644','69625','35082',
                          '22689','50675','10316','26963','33456',
                          '77399','21988','80253','62318','14592',
                          '40728','59148','57366','91512','97825',
                          '30523','41509','25225','38975','41858',
                          '85994','97761','16579','86148','14699',
                          '65791','88223','67670','20004','12398',
                          '23241','66325','56939','71551','47971',
                          '11560','88946','13834','59870','47409',
                          '41708','72312','21693','99615','40840',
                          '36420','72284','14312','42008','87976',
                          '23586','45377','57878','45715','44373',
                          '80966','11953','32473','88337','69746',
                          '25452','97558','55154','54415','93332',
                          '76910','71388','97671','85805','88748',
                          '66234','24499','14966','96566','43489',
                          '10450','44184','87988','78783','18024',
                          '41943','13200','89019','50138','31983',
                          '72651','47978','40314','39757','22428',
                          '72011','51881','68462','67636','81282',
                          '47590','19401','29048','69661','79039',
                          '11165','83293','97057','40033','30326',
                          '39200','34641','53193','96935','62050',
                          '96080','13334','58035','91000','67796',
                          '31385','20987','37546','28416','16163',
                          '33782','33682','33132','79548','10831',
                          '86713','69226','20045','13996','93788',
                          '34988','74805','21574','49646','93018',
                          '70057','35747','27120','16740','48289',
                          '39987','14073','11963','13590','84188',
                          '34754','58720','33980','78023','17880',
                          '38872','24098','69274','39621','42198',
                          '26385','23618','40018','57930','64215',
                          '87192','51888','24329','13765','15619',
                          '45806','11906','68746','51580','16591',
                          '74102','39878','46661','47710','60954',
                          '15203','43605','65174','83930','39248',
                          '15991','86604','25479','21240','30355',
                          '80128','53194','19052','38387','38446',
                          '33608','75123','12707','65196','84334',
                          '71697','44793','20990','27082')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-07-08' as date) and (cast('2002-07-08' as date) + INTERVAL  60 DAY)
 and i_manufact_id in (494,685,590,290)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 2000 AND 2000 + 2) t5
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Green Acres'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  21922
   and ib_upper_bound   <=  21922 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('magenta','snow','lime'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 1
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (1,2,10,6,8,9) and
       d_year = 2002 and
       ca_state in ('KS','TX','ID'
                   ,'MI','WI','TN','AL')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('VA', 'KS', 'FL')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MI', 'NM', 'LA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'ND', 'IL')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-01-02','2002-08-20','2002-11-09')))
