with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('turquoise','sandy','light'))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-01-05','2002-09-14','2002-11-02')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 12 and 12+10 
             or ss_coupon_amt between 10719 and 10719+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 100 and 100+10
          or ss_coupon_amt between 7737 and 7737+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 110 and 110+10
          or ss_coupon_amt between 2877 and 2877+1000
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '59533','67910','27990','85824','62384','91725',
                          '36937','99249','92287','22473','51681',
                          '66416','29851','62272','57524','82547',
                          '43239','85340','55435','22428','25171',
                          '49239','62202','38020','98003','81750',
                          '25514','15863','10367','61514','17685',
                          '95878','39876','72455','50365','41669',
                          '41724','82214','64986','83694','70605',
                          '23004','16597','50953','71538','87854',
                          '16395','14802','26839','67054','67966',
                          '63560','71432','92188','95852','10118',
                          '46799','13647','57825','61425','88299',
                          '36374','41039','88072','73394','15692',
                          '76400','63136','40658','14533','48262',
                          '78329','22237','83532','78630','51516',
                          '44412','61424','50677','60359','34325',
                          '42962','52514','93772','20049','76031',
                          '60709','11441','87414','78460','67738',
                          '72326','72486','19591','53207','29349',
                          '60282','95598','69176','71385','98703',
                          '16682','86810','61728','63274','22192',
                          '82825','43454','55505','27429','22896',
                          '26589','51673','62590','84749','81540',
                          '59025','82130','92440','76442','93797',
                          '25810','67503','13307','16149','28587',
                          '75495','76688','36578','48247','42754',
                          '30871','28115','14186','60346','81820',
                          '99382','39606','56697','26603','52492',
                          '79202','92450','10898','76644','35212',
                          '19517','61480','95084','33522','60819',
                          '37279','12560','54673','63846','56048',
                          '52483','98034','81381','92569','79212',
                          '49691','78744','65471','96148','88921',
                          '91740','81844','60198','86523','41792',
                          '78368','62671','76380','23370','67578',
                          '20746','16202','54102','17558','73211',
                          '90182','90536','54697','91192','11922',
                          '88702','50259','50002','86814','52569',
                          '86537','67774','43266','69033','88403',
                          '62228','29813','48033','65513','97833',
                          '14708','54638','80040','85381','35649',
                          '92199','44580','46068','46099','80836',
                          '25485','78412','66480','47137','60674',
                          '38214','56706','93374','58367','37066',
                          '26991','79036','45940','28655','64633',
                          '16608','75784','89828','29502','44620',
                          '98482','35575','99383','18024','48862',
                          '71539','81890','24380','27909','94411',
                          '59006','42138','99274','92604','36008',
                          '81069','75993','13476','21100','53031',
                          '47812','98310','34262','25663','59542',
                          '60370','31662','33909','57042','81265',
                          '40106','91864','49255','36173','41817',
                          '53570','56650','79344','32680','77510',
                          '57265','93531','74358','68536','45380',
                          '92398','63077','29815','96096','66556',
                          '39944','24571','39830','78949','80515',
                          '37858','20728','34783','53606','39383',
                          '54033','36738','41200','13603','63311',
                          '50602','84708','71558','16749','92140',
                          '82179','71267','17811','49051','70675',
                          '57686','43294','93906','59071','59285',
                          '35968','37304','34805','63289','80897',
                          '65572','49196','26716','33953','49319',
                          '55893','11988','40486','26438','99226',
                          '78159','68248','30847','33562','88701',
                          '37283','99085','41613','10412','94292',
                          '74841','34333','94370','36922','50999',
                          '71139','77875','15915','75733','54824',
                          '36297','50102','40724','16119','13534',
                          '56770','85418','92738','80649','70937',
                          '86963','58521','13624','24473','24739',
                          '39546','95578','66730','71998','28700',
                          '17940','11042','93257','11056','84985',
                          '75265','28894','66905','20314','98146',
                          '29344','22728','74740','18014','57422',
                          '78410','84323','48587','21669','33752',
                          '72542','58559','52842','62285','85741',
                          '47681','99301','53931','83310','71852',
                          '42815','63001','68650','30537')
     intersect
      select ca_zip
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Sunflower County','Adams County','Laclede County','Mahaska County','Jefferson County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and i_manufact_id in (420,347,545,702)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Hillcrest'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  55038
   and ib_upper_bound   <=  55038 + 50000
...
select  i_item_id
 ...
 and i_manufact_id in (980,810,668,998)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('metallic','cornsilk','red','antique','thistle','linen') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 64330
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 237585
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 203845
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 82732
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 53025
            then (select avg(ss_ext_tax)
                  from store_sales
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,11,12,4,1,6) and
       d_year = 2002 and
       ca_state in ('TX','SC','WA'
                   ,'OK','GA','MS','FL')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TN', 'KY', 'IA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ND', 'CA', 'GA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('IL', 'OH', 'NE')
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Oak Grove','Midway','Fairview','Five Points','Fairview') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Books','Children','Home') and
          i_class in ('fiction','school-uniforms','curtains/drapes')
         )
      or (i_category in ('Women','Shoes','Men') and
          i_class in ('swimwear','womens','shirts') 
        ))
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 20795 and 20795+28800 
