with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-05-18','2001-09-22','2001-11-11')))
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 34528 and 34528+28800 
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Bethel'
   ...
   and ib_lower_bound   >=  45990
   and ib_upper_bound   <=  45990 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TX', 'CA', 'MI')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('CO', 'AL', 'MO')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MT', 'WV', 'MD')
...
select  
  ...
  ,sm_type
  ,cc_name
  ,sum(case when (cs_ship_date_sk - cs_sold_date_sk <= 30 ) then 1 else 0 end)  as " INTERVAL30 DAY" 
  ,sum(case when (cs_ship_date_sk - cs_sold_date_sk > 30) and 
                 (cs_ship_date_sk - cs_sold_date_sk <= 60) then 1 else 0 end )  as "31- INTERVAL60 DAY" 
  ,sum(case when (cs_ship_date_sk - cs_sold_date_sk > 60) and 
                 (cs_ship_date_sk - cs_sold_date_sk <= 90) then 1 else 0 end)  as "61- INTERVAL90 DAY" 
  ,sum(case when (cs_ship_date_sk - cs_sold_date_sk > 90) and
                 (cs_ship_date_sk - cs_sold_date_sk <= 120) then 1 else 0 end)  as "91- INTERVAL120 DAY" 
  ,sum(case when (cs_ship_date_sk - cs_sold_date_sk  > 120) then 1 else 0 end)  as "> INTERVAL120 DAY" 
from
   catalog_sales
  ,warehouse
  ,ship_mode
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 128 and 128+10
          or ss_coupon_amt between 16066 and 16066+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 44 and 44+10
          or ss_coupon_amt between 13906 and 13906+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 183 and 183+10
          or ss_coupon_amt between 10454 and 10454+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 66 and 66+10
          or ss_coupon_amt between 16209 and 16209+1000
 ...
 where i_manufact_id between 851 and 851+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'tan' or i_color = 'antique') and 
        ...
        (i_category = 'Men' and
        (i_color = 'peach' or i_color = 'white') and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '74817','75115','84728','34031','60045','68768',
                          '52081','74789','59752','18922','15956',
                          '90646','19972','29179','53049','24771',
                          '65965','48056','23497','92861','25629',
                          '42751','66435','96057','44651','35650',
                          '67017','61433','47643','24608','30268',
                          '84460','99222','50316','55239','82689',
                          '15402','92220','56556','66473','98255',
                          '74921','45702','83293','63508','48376',
                          '40416','27696','73346','21262','47161',
                          '60061','74448','26321','74927','20989',
                          '38836','94712','49800','87855','69917',
                          '18895','20281','30539','17294','86590',
                          '96068','89576','80952','92296','39330',
                          '60899','51443','66777','95654','73291',
                          '80417','16211','70336','19002','94966',
                          '41820','71932','79537','92525','71582',
                          '59296','12389','95238','41620','58870',
                          '72509','49113','38869','41135','11495',
                          '71892','44410','82425','45540','35615',
                          '85312','40172','17845','48316','76431',
                          '57683','83907','31810','90981','71336',
                          '41076','53410','21173','77632','31016',
                          '39387','61378','42343','96504','90734',
                          '52365','60892','45914','71212','85426',
                          '90718','43072','23564','49515','57933',
                          '39613','40005','14844','29723','33284',
                          '77900','22384','61256','13044','20801',
                          '87144','68812','84185','99653','31949',
                          '50199','96569','76910','69965','22133',
                          '77178','61782','50602','75068','42929',
                          '30645','93361','44680','31655','97989',
                          '38303','31468','45427','97217','17333',
                          '48661','18450','33804','53812','61617',
                          '80781','97980','86861','32648','55305',
                          '30452','46328','87002','70086','17915',
                          '54097','12953','80321','71552','17141',
                          '36827','26714','86491','91112','54868',
                          '95787','45330','86377','93914','69255',
                          '91862','38176','79440','35613','53268',
                          '55999','50100','67313','14731','61875',
                          '85206','18586','26747','30660','73786',
                          '58791','84188','56841','97406','55910',
                          '50603','48529','96727','75998','87209',
                          '72613','96530','18422','56191','72981',
                          '85411','52759','86793','51396','43159',
                          '15426','28976','24284','87179','12506',
                          '54266','51641','27432','66396','83996',
                          '93510','28836','97630','90102','79647',
                          '44072','20215','14618','40412','77330',
                          '72450','62794','94857','69679','20431',
                          '66542','10607','76326','31043','40036',
                          '28679','66515','88306','85241','51274',
                          '45476','71627','24582','86421','40642',
                          '80878','27944','72691','78711','18941',
                          '59129','72288','35813','33192','19364',
                          '35720','78240','87032','63414','59442',
                          '46515','22004','66083','12300','23364',
                          '48265','33821','82666','17369','34529',
                          '31874','63648','84447','53627','48097',
                          '51241','66962','62041','35361','92141',
                          '22006','71145','97088','10832','12837',
                          '95941','78618','94192','78931','68683',
                          '81980','79020','31420','32091','60084',
                          '62911','53647','95592','87767','66833',
                          '45241','19032','93498','21567','29622',
                          '40932','16564','91313','96015','88959',
                          '28877','75482','13211','14552','53427',
                          '46801','84868','35790','37632','47715',
                          '35908','93330','73834','21022','91238',
                          '45839','82677','60173','45633','77384',
                          '16075','39761','35081','76668','69986',
                          '76170','44587','17414','71104','15700',
                          '10553','91180','23819','64801','26109',
                          '15394','66823','52388','33322','82133',
                          '71567','56571','24278','36453','29330',
                          '54522','37395','35427','84865','19303',
                          '35812','89185','44528','42169','91397',
                          '68758','75429','74714','48634','58658',
                          '43117','58397','27538','62774')
     intersect
      select ca_zip
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 1999 AND 1999 + 2) t0
...
select  
  ...
  ,s_state
  ,s_zip
  ,sum(case when (sr_returned_date_sk - ss_sold_date_sk <= 30 ) then 1 else 0 end)  as " INTERVAL30 DAY" 
  ,sum(case when (sr_returned_date_sk - ss_sold_date_sk > 30) and 
                 (sr_returned_date_sk - ss_sold_date_sk <= 60) then 1 else 0 end )  as "31- INTERVAL60 DAY" 
  ,sum(case when (sr_returned_date_sk - ss_sold_date_sk > 60) and 
                 (sr_returned_date_sk - ss_sold_date_sk <= 90) then 1 else 0 end)  as "61- INTERVAL90 DAY" 
  ,sum(case when (sr_returned_date_sk - ss_sold_date_sk > 90) and
                 (sr_returned_date_sk - ss_sold_date_sk <= 120) then 1 else 0 end)  as "91- INTERVAL120 DAY" 
  ,sum(case when (sr_returned_date_sk - ss_sold_date_sk  > 120) then 1 else 0 end)  as "> INTERVAL120 DAY" 
from
   store_sales
  ,store_returns
  ,store
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-05' as date) 
                  and (cast('1999-08-05' as date) + INTERVAL  14 DAY)
...
select  i_item_id
 ...
 and d_date between cast('2001-06-26' as date) and (cast('2001-06-26' as date) + INTERVAL  60 DAY)
 and i_manufact_id in (461,690,574,561)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,2,7,10,11,3) and
       d_year = 1998 and
       ca_state in ('ID','IN','CO'
                   ,'NM','AL','LA','MT')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 60054
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 155804
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 104949
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 194974
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 49753
            then (select avg(ss_ext_tax)
                  from store_sales
...
select  i_item_id
 ...
 and i_manufact_id in (803,980,772,677)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('navajo','olive','almond','powder','rosy','purple') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Oak Grove','Five Points','Fairview','Midway','Fairview') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Children','Electronics','Home') and
          i_class in ('school-uniforms','televisions','curtains/drapes')
         )
      or (i_category in ('Women','Men','Shoes') and
          i_class in ('fragrances','sports-apparel','mens') 
        ))
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Schuyler County','East Baton Rouge Parish','Livingston County','Eureka County','Glenn County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  
  ...
  ,sm_type
  ,web_name
  ,sum(case when (ws_ship_date_sk - ws_sold_date_sk <= 30 ) then 1 else 0 end)  as " INTERVAL30 DAY" 
  ,sum(case when (ws_ship_date_sk - ws_sold_date_sk > 30) and 
                 (ws_ship_date_sk - ws_sold_date_sk <= 60) then 1 else 0 end )  as "31- INTERVAL60 DAY" 
  ,sum(case when (ws_ship_date_sk - ws_sold_date_sk > 60) and 
                 (ws_ship_date_sk - ws_sold_date_sk <= 90) then 1 else 0 end)  as "61- INTERVAL90 DAY" 
  ,sum(case when (ws_ship_date_sk - ws_sold_date_sk > 90) and
                 (ws_ship_date_sk - ws_sold_date_sk <= 120) then 1 else 0 end)  as "91- INTERVAL120 DAY" 
  ,sum(case when (ws_ship_date_sk - ws_sold_date_sk  > 120) then 1 else 0 end)  as "> INTERVAL120 DAY" 
from
   web_sales
  ,warehouse
  ,ship_mode
 ...
 from (select cs_quantity*cs_list_price sales
      ...
      select ws_quantity*ws_list_price sales
       ...
       where d_year = 2000 
         ...
         and ws_bill_customer_sk in (select c_customer_sk from best_ss_customer)) t4 
 limit 100;
with frequent_ss_items as
 (select substr(i_item_desc,1,30) itemdesc,i_item_sk item_sk,d_date solddate,count(*) cnt
  from store_sales
 ...
 from (select c_last_name,c_first_name,sum(cs_quantity*cs_list_price) sales
      ...
      select c_last_name,c_first_name,sum(ws_quantity*ws_list_price) sales
       ...
       group by c_last_name,c_first_name) t6 
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('moccasin','peru','beige'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 4
