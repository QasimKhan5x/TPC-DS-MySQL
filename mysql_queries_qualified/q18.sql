...
SELECT
    ...
    CA_COUNTY,
    AVG(
        CAST(CS_QUANTITY AS DECIMAL(12, 2))
    ) AGG1,
    AVG(
        CAST(CS_LIST_PRICE AS DECIMAL(12, 2))
    ) AGG2,
    AVG(
        CAST(CS_COUPON_AMT AS DECIMAL(12, 2))
    ) AGG3,
    AVG(
        CAST(
    ...
    AVG(
        CAST(CS_NET_PROFIT AS DECIMAL(12, 2))
    ) AGG5,
    AVG(
        CAST(C_BIRTH_YEAR AS DECIMAL(12, 2))
    ) AGG6,
    AVG(
        CAST(
