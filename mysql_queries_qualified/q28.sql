...
FROM (
        ...
        WHERE
            ...
            AND (
                SS_LIST_PRICE BETWEEN 73 AND 73 + 10
        ...
        WHERE
            ...
            AND (
                SS_LIST_PRICE BETWEEN 152 AND 152 + 10
                OR SS_COUPON_AMT BETWEEN 2196 AND 2196 + 1000
                OR SS_WHOLESALE_COST BETWEEN 56 AND 56 + 20
            )
    ) B2, (
        SELECT
        ...
        WHERE
            ...
            AND (
                SS_LIST_PRICE BETWEEN 53 AND 53 + 10
                OR SS_COUPON_AMT BETWEEN 3430 AND 3430 + 1000
                OR SS_WHOLESALE_COST BETWEEN 13 AND 13 + 20
            )
    ) B3, (
        SELECT
        ...
        WHERE
            ...
            AND (
                SS_LIST_PRICE BETWEEN 182 AND 182 + 10
        ...
        WHERE
            ...
            AND (
                SS_LIST_PRICE BETWEEN 85 AND 85 + 10
                OR SS_COUPON_AMT BETWEEN 3310 AND 3310 + 1000
                OR SS_WHOLESALE_COST BETWEEN 37 AND 37 + 20
            )
    ) B5, (
        SELECT
        ...
        WHERE
            ...
            AND (
                SS_LIST_PRICE BETWEEN 180 AND 180 + 10
                OR SS_COUPON_AMT BETWEEN 12592 AND 12592 + 1000
                OR SS_WHOLESALE_COST BETWEEN 22 AND 22 + 20
            )
    ) B6
LIMIT 100;